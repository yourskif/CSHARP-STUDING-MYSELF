...
namespace BookStore.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        // Головна сторінка зі списком авторів
        ...
        // Видалення автора (підтвердження)
        ...
        public async Task<IActionResult> SaveBooks([FromBody] SaveBooksRequest request)
        {
            ...
            // Використовуємо AddRangeAsync для ефективного додавання книг
        ...
        // Модель запиту для збереження книг
        ...
        // Створення автора (форма)
        public IActionResult Create()
        {
            return View();
        }

        // Створення автора (збереження)
        [HttpPost]
        [ValidateAntiForgeryToken]
